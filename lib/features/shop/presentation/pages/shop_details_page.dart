          ...
          listener: (context, state) {
            if (state is ShopLoaded) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                  content: Text('Informasi toko tersimpan!'),
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Informasi ini akan muncul di struk digital dan cetak.',
                    ...
                    _buildTextField(
                      ...
                      validator: AppValidators.required('Wajib diisi'),
                    ),
                    const SizedBox(height: 15),
                    const InputLabel(text: 'Alamat Baris 1'),
                    _buildTextField(
                      controller: _address1Controller,
                      hint: 'Ukui 1, Kab. Pelalawan, Riau',
                      validator: AppValidators.required('Wajib diisi'),
                    ),
                    const SizedBox(height: 15),
                    ...
                    _buildTextField(
                      ...
                      hint: 'programmer.2nd@gmail.com',
                    ),
                    const SizedBox(height: 15),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const InputLabel(text: 'Teks Penutup Struk'),
                    ...
                    _buildTextField(
                      ...
                      hint: 'Terima kasih, datang kembali!',
                      maxLines: 2,
                      maxLength: 60,
                    ),
                  ],
